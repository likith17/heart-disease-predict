...
# > The dataset is loaded as `heart\_df` inside the notebook.
...
# accuracy\_log\_reg, accuracy\_decision\_tree, accuracy\_random\_forest,

# accuracy\_gradient\_boosting, accuracy\_svc
